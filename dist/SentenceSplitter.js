(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "./Sentence", "nlptoolkit-dictionary/dist/Dictionary/Word", "nlptoolkit-dictionary/dist/Language/Language"], factory);
    }
    ...
    class SentenceSplitter {
        ...
        isNextCharUpperCaseOrDigit(line, i) {
            ...
            if (i == line.length || (this.upperCaseLetters() + Language_1.Language.DIGITS + "-").includes(line.charAt(i))) {
                return true;
            }
            else {
                return false;
        ...
        isTime(line, i) {
            if (i + 2 < line.length) {
                ...
                return Language_1.Language.DIGITS.includes(previousChar) && Language_1.Language.DIGITS.includes(nextChar)
                    && Language_1.Language.DIGITS.includes(twoNextChar);
            }
            else {
                return false;
            }
                    ...
                    if (this.SENTENCE_ENDERS.includes(line.charAt(i))) {
                        ...
                        if (line.charAt(i) == ' ') {
                            ...
                            if (line.charAt(i) == '-' && !webMode && roundParenthesisCount == 0 && this.isNextCharUpperCase(line, i + 1) && !this.isPreviousWordUpperCase(line, i - 1)) {
                                ...
                                if (this.PUNCTUATION_CHARACTERS.includes(line.charAt(i)) || Language_1.Language.ARITHMETIC_CHARACTERS.includes(line.charAt(i))) {
